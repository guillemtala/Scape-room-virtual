    ...
    <div class="column-100 row">
        ...
        <div class="column-80">
            ...
            <div class="text padding-laterales">
                <h2>Enhorabuena has acertado el tercer reto!!. A continuacion te dejo unos emojis, a ver si encuentras la respuesta.</h2>
            </div>
            <div class="flex gallery3">
                <img src="../img/adivinanza.png" alt="adivinanza">
            </div>
            ...
            <div class="padding-laterales">
                ...
                <form action="../proc/rec.proc.php" method="post">
                    ...
                    <br>
                    <div class="text flex">
                        <input type="text" name="respuesta4" class="insertar1" placeholder="Pon la respuesta aqui..."> 
                    </div>
                    <br>
                    <br>
                    <div class="flex">
                        <input type="submit" class="boton1" name="boton4" value="Enviar respuesta">
                    </div>
